...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-50 flex">
      ...
      >
        ...
        <div class="p-4 border-b border-gray-700">
          <div class="flex items-center justify-between">
            @if (sidebarOpen()) {
              <h1 class="text-xl font-bold cursor-pointer hover:text-gray-300 transition-colors" (click)="navigateToHome()" role="banner">Pokedex</h1>
            }
            <button
              (click)="toggleSidebar()"
        ...
        <!-- Sidebar Navigation -->
        <nav class="p-4 space-y-2" id="sidebar-navigation" role="navigation" aria-label="Main navigation">
          <a
            ...
            [attr.aria-label]="'Go to ' + (sidebarOpen() ? 'Overview' : 'Overview page')"
          >
          ...
          <a
            ...
            [attr.aria-label]="'Go to ' + (sidebarOpen() ? 'Pokemons' : 'Pokemons page')"
          >
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a
            ...
            [attr.aria-label]="'Go to ' + (sidebarOpen() ? 'My Collection' : 'My Collection page')"
          >
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      >
        <!-- Header -->
        <header class="bg-white shadow-sm border-b border-gray-200 h-[70px]" role="banner">
